...
const YearSelector = ({
	...
	useEffect(() => {
		...
		const currentRow = Math.floor(
			yearIndex / numbers.CALENDAR_YEAR_SELECTOR_COLUMNS,
		);
		// yearButton  => height 40 + padding 10
				...
				<View style={[styles.container]}>
					<View style={styles.yearsContainer}>
						<FlatList
							...
							numColumns={numbers.CALENDAR_YEAR_SELECTOR_COLUMNS}
						/>
					</View>
					<Pressable style={styles.closeButton} onPress={hide}>
						<Text style={styles.closeText}>{t('닫기')}</Text>
						<MaterialIcons
